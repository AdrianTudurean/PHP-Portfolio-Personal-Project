...
<html lang="en">
   ...
   <body background="BackgroundIMG.jpeg">
      ...
      <button style="margin:9px;" class = "btn btn-secondary btn btn-sm" type = "button" onclick="window.location.href='Contact.php'"><i class="las la-address-card"></i> Contact </button>
      </div>
      </div>
        ...
        <div class="col-md-8">
            <div class="well well-sm">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <button type="submit" class="btn btn-dark pull-right" id="btnContactUs">
                            Send Message</button>
                    </div>
                </div>
                </form>
